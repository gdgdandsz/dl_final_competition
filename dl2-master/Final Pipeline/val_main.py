...
def create_parser():
    ...
    parser.add_argument('--gpu', default='0, 1', type=str, help='Comma separated list of GPU ids to use')
    parser.add_argument('--seed', default=1, type=int)

    parser.add_argument('--model1_path', default='/scratch/yz8297/DL_comp/dl2-master/checkpoints/checkpoint.pth', type=str)

    parser.add_argument('--model2_path', default='/scratch/yz8297/DL_comp/dl2-master/checkpoints/unet.pth', type=str)  # remind to give correct path

    # dataset parameters
    parser.add_argument('--batch_size', default=4, type=int, help='Batch size')
    parser.add_argument('--val_batch_size', default=4, type=int, help='Batch size')
    parser.add_argument('--data_root', default='/scratch/yz8297/DL_comp/Dataset_Student/val_11')
